...
const FIELD_LABELS = {
  ...
  settlement_type: "Metode penyelesaian",
  settlement_date: "Tanggal penyelesaian",
  supplier_invoice_id: "Tagihan tujuan",
  invoice_id: "Invoice tujuan",
  delivery_id: "Delivery asal",
...
const VALUE_LABELS = {
  ...
  EXCESS: "Jumlah berlebih",
  UNOPENED: "Belum dibuka",
  OTHER: "Lainnya",
  INVOICE_DEDUCTION: "Potong tagihan asal",
  SUPPLIER_CREDIT: "Kredit ke tagihan lain",
  REFUND: "Dana dikembalikan supplier",
  REPLACEMENT: "Barang pengganti diterima",
};
