  ...
  return (
    <div className="stock-opnames-page">
      ...
      <section className="data-panel">
        <CollapsibleFilters ref={filtersRef} active={hasFilters} className="stock-opname-filters" onSubmit={(event) => { event.preventDefault(); setPage(1); setSearch(searchInput.trim()); }}>
