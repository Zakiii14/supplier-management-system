  ...
  return (
    <div className="purchase-returns-page">
      ...
      <section className="data-panel">
        <CollapsibleFilters ref={filtersRef} active={hasFilters} className="purchase-return-filters" onSubmit={(event) => { event.preventDefault(); setPage(1); setSearch(searchInput.trim()); }}>
